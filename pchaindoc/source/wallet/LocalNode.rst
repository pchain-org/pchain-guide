...
Important: 
Pchain RPC's defalut port is 6969, remember open your port 6969 **ONLY** to your local ip and **DO NOT** keep your account unlock for long time (the keystore file should copied to datadir/CHIAN_ID/keystore/ if you wanna send **any** transaction under local node mode)!!! 
